...
4. Alterar nome, celular e turma normalmente; o campo de status aparece apenas como referência e fica bloqueado na tela.
...
8. Para excluir o aluno, usar o botão **Excluir aluno**, confirmar a ação e aguardar o retorno para a tela principal.
9. Para validar a implantação, consultar `health` no Web App e conferir `version` e `deployedAt` na resposta.
